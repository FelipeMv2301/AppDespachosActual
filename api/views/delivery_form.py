...
class DeliveryFormView(APIView):
    ...
    def post(self, request: Request, *args, **kwargs):
        ...
        order = Order.objects.create(
            ...
            customer=customer,
            contact=contact,
            local_total_dcnt=data.get('total_discount'),
            doc_total_dcnt=data.get('total_discount'),
            local_total_tax=data.get('local_total_tax'),
            doc_total_tax=data.get('local_total_tax'),
