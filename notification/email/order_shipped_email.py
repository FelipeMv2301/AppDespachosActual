...
class OrderShippedEmail(Email):
    def __init__(self,
        ...
        try:
            deliv_query = (
                ...
                .values(
                    ...
                    # deliv_pay_type_code=F('order_grouping__delivery_option__pay_type__code'),
                    # deliv_serv_acct_code=F('delivery__service_acct__code'),
        ...
        tmpl_context = {
            ...
            'rcpt_commit_date': self.deliv_query['rcpt_commit_date'],
        ...
        match self.deliv_query['company_code']:
            ...
            case _:
                ...
                e = CustomError(msg=e_msg, log=tb)
                raise e
        tmpl_context['background'] = background
        tmpl_context['logo'] = os.path.relpath(
            path=os.path.join('app', 'img', logo))
